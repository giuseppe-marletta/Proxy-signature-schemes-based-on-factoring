...
{ 
    ...
    if (hash_out == 224)
        temp_value = hashing_macro(sha224_ctx, sha224_init, sha224_update, sha224_digest,
                         SHA224_DIGEST_SIZE,block_size_uno, (unsigned char *)block_to_hash_uno, block_size_due, (unsigned char *)block_to_hash_due);
    else if (hash_out == 256)
        temp_value = hashing_macro(sha256_ctx, sha256_init, sha256_update, sha256_digest,
                         SHA256_DIGEST_SIZE,block_size_uno, (unsigned char *)block_to_hash_uno, block_size_due, (unsigned char *)block_to_hash_due);
    else if (hash_out == 384)
        temp_value = hashing_macro(sha384_ctx, sha384_init, sha384_update, sha384_digest,
                         SHA384_DIGEST_SIZE,block_size_uno, (unsigned char *)block_to_hash_uno, block_size_due, (unsigned char *)block_to_hash_due);
    else 
        temp_value = hashing_macro(sha512_ctx, sha512_init, sha512_update, sha512_digest,
                         SHA512_DIGEST_SIZE,block_size_uno, (unsigned char *)block_to_hash_uno, block_size_due, (unsigned char *)block_to_hash_due);
